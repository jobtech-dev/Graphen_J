...
class JsonJtConfigurationParsing extends AnyFunSuite with Matchers with JsonConfigParser {

  test("parse complete configuration with JtEtlDQJobConfiguration") {
    val json =
      """{
        |  "jobType": "ETL_DQ",
        |  "session": {
  ...
  test("parse complete configuration with JtDQJobConfiguration") {
    val json =
      """{
        |  "jobType": "DQ",
        |  "session": {
  ...
  test("parse complete configuration with JtEtlJobConfiguration") {
    val json =
      """{
        |  "jobType": "ETL",
        |  "session": {
