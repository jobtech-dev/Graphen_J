...
class YamlJtEtlDQJobConfigurationParserTest extends AnyFunSuite with Matchers with YamlConfigParser {
  ...
  test("parse complete configurations") {
    ...
    val res         = parseYamlConfig[JtEtlDQJobConfiguration](yml)
